// ignore_for_file: unnecessary_new, prefer_const_constructors, deprecated_member_use, unnecessary_null_comparison, no_leading_underscores_for_local_identifiers, annotate_overrides, prefer_typing_uninitialized_variables, prefer_final_fields, body_might_complete_normally_nullable, unnecessary_cast
...
class HttpUtil {
  ...
  HttpUtil._internal() {
    ...
    dio.interceptors.add(InterceptorsWrapper(
      ...
      // 错误提示
      toastInfo(msg: eInfo.message.toString());
      // 错误交互处理
